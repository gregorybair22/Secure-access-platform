        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalTicket = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CustomerTicket = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PlainData = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecretData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CredentialTemplates_CredentialTypes_CredentialTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CredentialType = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Reason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    InternalTicket = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CustomerTicket = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedByUserName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChangeLogs_Users_ModifiedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddress = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    UserAgent = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MachinesAccessed = table.Column<int>(type: "int", nullable: false),
                    CustomersAccessed = table.Column<int>(type: "int", nullable: false),
                    CredentialsViewed = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Credentials_Machines_MachineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sha256 = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_ReasonCategory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChangeLogs_ModifiedAtUtc",
                table: "ChangeLogs",
                column: "ModifiedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_ChangeLogs_ModifiedByUserId",
                table: "ChangeLogs",
                column: "ModifiedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Clients_CustomerCode",
                table: "Clients",
                column: "CustomerCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Credentials_MachineId",
                table: "Credentials",
                column: "MachineId");

            migrationBuilder.CreateIndex(
                name: "IX_Credentials_Scope_ClientId_MachineId",
                table: "Credentials",
                columns: new[] { "Scope", "ClientId", "MachineId" });

            migrationBuilder.CreateIndex(
                name: "IX_CredentialTemplates_CredentialTypeId",
                table: "CredentialTemplates",
                column: "CredentialTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CredentialTypes_Name",
                table: "CredentialTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LoginLogs_TimestampUtc",
                table: "LoginLogs",
                column: "TimestampUtc");
